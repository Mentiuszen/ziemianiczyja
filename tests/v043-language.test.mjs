...
test('message params are resolved on display, including a remapped interaction key',()=>{const l=requireLocale();l.setLanguage('en');const hint=l.text(OBJECTIVES[3].hint,{interact:'F'});assert.match(hint,/\[F\]/);assert.doesNotMatch(hint,/\[E\]|\{interact\}/);l.setLanguage('pl');});
