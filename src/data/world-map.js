...
export const MISSION_VERSION=3;
/** Move the northern sector, preserving the authored start, first line and aid station. */
export const northZ=z=>z>=85?z+40:z;
export const LANDMARKS=Object.freeze({orders:{x:33,z:-7},artillery:{x:36,z:110},bunker:{x:23,z:60},aid:{x:-27,z:69},telephone:{x:4,z:159}});
...
export const HQ=Object.freeze({x:33,z:-7.8,w:12,d:8.4,h:3.25,spawn:{x:32,z:-9.4},exit:{x:40,z:-7.8}});
