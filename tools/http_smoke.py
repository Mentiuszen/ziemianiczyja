...
for mode,prefix in [('source',''),('dist',''),('dist','test-repo')]:
    ...
    try:
        ...
        paths=['index.html','src/app.js','src/ui/style.css','src/render/quality.js','public/assets/models/lewis.glb','public/assets/models/field-gun-77.glb','public/assets/models/dh5.glb','public/assets/models/dfw.glb','public/assets/textures/briefing-map.jpg','src/performance/frame-limiter.js','src/ui/styles/menus.css','src/ui/styles/hud.css','src/ui/screens/campaign.js','src/ui/hud/minimap.js','src/ui/hud/projection.js','public/assets/ui/main-art.webp','public/assets/ui/logo.svg','public/assets/ui/campaign-base.svg','public/assets/ui/ally-uk.svg','public/assets/ui/weapons/smle.svg']
...
report['passed']=True
out=P/'.local/v0.4.4-tests/http-smoke.json';out.parent.mkdir(parents=True,exist_ok=True);out.write_text(json.dumps(report,indent=2));print('PASS',len(report['checks']),'static-server configurations')
